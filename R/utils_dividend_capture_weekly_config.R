...
DIVIDEND_CAPTURE_CONFIG <- list(
  ...
  min_success_rate = get_golem_config_value("weekly_capture", "min_success_rate", 70.0),
  exclude_negative_returns = get_golem_config_value("weekly_capture", "exclude_negative_returns", TRUE),
  ...
  max_workers = get_golem_config_value("weekly_capture", "max_workers", 10),
